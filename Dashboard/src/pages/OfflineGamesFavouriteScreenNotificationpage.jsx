...
import { sendFavouriteGamesScreenNotificationToAllUsers } from "@/store/Slices/offlinegamesappgamesSlice"
import { ArrowLeft } from "lucide-react"
import { Link } from "react-router-dom"

const OfflineGamesFavouriteScreenNotificationpage = () => {
    ...
    const onSubmit = async (data) => {
        ...
        const response = await dispatch(sendFavouriteGamesScreenNotificationToAllUsers({ data }));
    ...
    return (
        <div className="max-w-xl mx-auto p-6">
            <Card className="relative">
                ...
                <CardHeader>
                    <CardTitle className="text-xl mt-5">Favourite Games Screen Notification</CardTitle>
                </CardHeader>
                <CardContent>
...
export { OfflineGamesFavouriteScreenNotificationpage }
