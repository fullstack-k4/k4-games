...
import { getById, update, makeGameNull } from "@/store/Slices/knifethrowgamesSlice";


const KnifeAppEditGamepage = () => {
    ...
    const gameData = useSelector((state) => state.knifethrowgames.game);
