...
const CreateBannerpage = () => {
    ...
    const positions = ["Home_Top", "Home_Bottom", "Home_Sticky", "Game_Sticky", "Game_Category", "Game_Category_Sticky", "Pop_Up_Ad"];
    ...
    return (
        <Container className="flex justify-center items-center min-h-screen">
            <div className="w-full max-w-2xl relative p-6 bg-white dark:bg-gray-900 shadow-xl rounded-lg space-y-6">
                ...
                <h2 className="text-2xl font-bold text-center">Create Ad Banner</h2>
