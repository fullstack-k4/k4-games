...
import { uploadGame } from "@/store/Slices/knifethrowgamesSlice";



const UploadKnifeThrowGamespage = () => {
    const { register, handleSubmit, setValue, formState: { errors }, watch, control } = useForm({
    });

    const [loader, setloader] = useState(true);
    const dispatch = useDispatch();
    const loading = useSelector((state) => state.knifethrowgames.loading);
...
export { UploadKnifeThrowGamespage };
